...
def default_registry() -> FactorRegistry:
    return FactorRegistry(
        [
            ...
            FactorDefinition("liquidation_imbalance_5m", "crypto.derivatives.v1", "usd", "directly_observed_flow", 600, 0.8),
            ...
            FactorDefinition("vix_level", "crossasset.risk_appetite.v1", "index", "direct_observation", 3600, 0.9),
            ...
            FactorDefinition("fred_vintage_surprise", "macro.us_growth_inflation.v1", "zscore", "direct_observation", 172800, 0.9),
            FactorDefinition("alfred_revision_surprise", "macro.us_growth_inflation.v1", "zscore", "direct_observation", 172800, 0.9),
            ...
            FactorDefinition("tier_a_event_state", "news.event_impact.v1", "category", "direct_observation", 21600, 0.9),
        ]
    )
